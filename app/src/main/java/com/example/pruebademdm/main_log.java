        ...
        HttpUtils.get("/habilidades", null, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    ArrayAdapter<Habilidad> dataAdapter = new ArrayAdapter<Habilidad>(pantalla, android.R.layout.simple_spinner_item, habilidades);
                            ...
                            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                                try {
                                    ...
                                    for (int i = 0; i < alertasJSON.length(); i++) {
                                        ...
                                        PendingIntent pendingIntent = PendingIntent.getActivity(pantalla, i, intent, PendingIntent.FLAG_UPDATE_CURRENT);
                                        ...
                                        NotificationCompat.Builder builder = new NotificationCompat.Builder(pantalla, CHANNEL_ID)
                                                ...
                                                .setContentTitle("Tienes un mensaje de " + nombre_usuario + "!")
